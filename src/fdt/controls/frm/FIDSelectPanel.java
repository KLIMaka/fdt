...
public class FIDSelectPanel extends Composite {
    ...
    public void fill() {
        ...
        try {
            ...
            m_pal = FDT.getStdPal(m_fact.getProject());
        } catch (IOException e) {
            e.printStackTrace();
            m_frm = null;
            return;
    ...
    protected void createActions() {
        m_playAction = new Action("Play") {
            ...
            public void play() {
                ...
                m_playAction.setImageDescriptor(FDT.getImageDescriptor("icons/suspend_co.gif"));
                m_mgr.update(true);
            }
            ...
            public void stop() {
                ...
                m_playAction.setImageDescriptor(FDT.getImageDescriptor("icons/resume_co.gif"));
                m_mgr.update(true);
            }
        };
        m_playAction.setImageDescriptor(FDT.getImageDescriptor("icons/resume_co.gif"));
        ...
        m_left.setImageDescriptor(FDT.getImageDescriptor("icons/undo_edit.gif"));
        ...
        m_right.setImageDescriptor(FDT.getImageDescriptor("icons/redo_edit.gif"));
        ...
        m_center.setImageDescriptor(FDT.getImageDescriptor("icons/link_to_editor.gif"));
        ...
        m_change.setImageDescriptor(FDT.getImageDescriptor("icons/add.gif"));
