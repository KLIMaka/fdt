...
public class FalloutProjectPropertyPage extends PropertyPage {
	...
	private SslSettingsContext m_settings;
	...
	protected Control createContents(Composite parent) {
		...
		m_settings = new SslSettingsContext(m_project);
		...
		m_cfgPath.setText(m_settings.get(PreferenceConstants.C_CFG));
		...
		m_cpType.setText(m_settings.get(PreferenceConstants.C_COMPILER_TYPE));
		...
		m_cpPath.setText(m_settings.get(PreferenceConstants.P_COMPILER));
		...
		m_cpOptions.setText(m_settings.get(PreferenceConstants.P_COMPILER_OPTIONS));
		new Label(m_group, SWT.NONE);
		...
		m_ppPath.setText(m_settings.get(PreferenceConstants.P_PREPROCESSOR));
		...
		m_ppOptions.setText(m_settings.get(PreferenceConstants.P_PP_OPTIONS));
		new Label(m_group, SWT.NONE);
		...
		m_dcpPath.setText(m_settings.get(PreferenceConstants.P_DECOMPILER));
