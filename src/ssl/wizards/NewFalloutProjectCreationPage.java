...
import ssl.preferences.FalloutPreferencePage;
...
public class NewFalloutProjectCreationPage extends WizardNewProjectCreationPage {
    ...
    public void createControl(Composite parent) {
        ...
        m_cbEncoding.setText(SslPlugin.getDefault().getPreferenceStore().getString(PreferenceConstants.P_ENCODING));
        ...
        m_tfPath.setText(SslPlugin.getDefault().getPreferenceStore().getString(PreferenceConstants.P_FALLOUT_DIRECTORY)
                + "\\fallout2.cfg");
        ...
        m_tfCompilerPath.setText(SslPlugin.getDefault().getPreferenceStore().getString(PreferenceConstants.P_COMPILER));
